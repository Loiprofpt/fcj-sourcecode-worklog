...
| **III. Backend Services** | Tuần 5–7 | • Phát triển Lambda Functions (Node.js)<br>• Cấu hình API Gateway & Rules Engine<br>• Thiết lập CodePipeline cho Backend | • Serverless Stack đã triển khai<br>• REST API hoạt động<br>• Pipeline Backend tự động | 20 man-days |
