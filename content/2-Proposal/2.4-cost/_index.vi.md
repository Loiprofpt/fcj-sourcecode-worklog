...
| **AWS Amplify** | **$2.72** | Hosting, 100 phút build, 20GB data transfer. |
| **AWS IoT Core** | **$1.00** | Chi phí kết nối & MQTT cho ~10.000 messages. |
| **AWS CodePipeline** | **$1.00** | 1 pipeline hoạt động cho Backend CI/CD (Terraform). |
| **Amazon Route 53** | **$0.50** | 1 Hosted Zone cho domain riêng. |
...
| **AWS CodeBuild** | **$0.00** | Trong Free Tier (100 phút/tháng). |
| **TỔNG** | **~$14.33** | **Mỗi tháng** |

> **Lưu ý:** Chi phí có thể thay đổi tuỳ theo lượng data transfer và khu vực triển khai. Với Free Tier, chi phí thực tế có thể giảm xuống **< $10/tháng** trong 12 tháng đầu.
...
| **Nguồn & phụ kiện** | Pin, dây, vỏ in 3D | $5.00 | Vật tư phụ trợ. |
| **TỔNG** |  | **~$30.00** | **Mỗi thiết bị** |
